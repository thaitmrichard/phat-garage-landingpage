    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-black text-white">
      ...
      <div className="container mx-auto px-4 md:px-6 z-20">
        <div className="max-w-4xl">
          ...
          >
            <span className="inline-block py-1 px-3 mb-6 border border-brand-red text-brand-red text-xs font-black uppercase tracking-[0.2em] rounded-sm bg-brand-red/10">
              Technology & Innovation
            </span>
            
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 leading-tight uppercase italic tracking-tighter">
              PHÁT <span className="text-brand-red">GARAGE</span><br />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                className="bg-brand-red hover:bg-red-700 text-white font-black uppercase tracking-widest px-8 py-7 text-lg group h-auto transition-all hover:translate-x-1"
              >
          ...
          >
            <div className="flex items-center gap-4">
              <div className="text-brand-red"><ShieldCheck size={32} /></div>
              <div>
            ...
            <div className="flex items-center gap-4">
              <div className="text-brand-red"><Zap size={32} /></div>
              <div>
            ...
            <div className="flex items-center gap-4">
              <div className="text-brand-red"><Award size={32} /></div>
              <div>
