      ...
      <div className="container mx-auto px-4 md:px-6 z-20">
        <div className="max-w-4xl">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-black mb-6 leading-tight uppercase italic tracking-tighter">
              PHÁT <span className="text-brand-orange">GARAGE</span><br />
              <span className="text-gray-300">CHĂM SÓC XE BẰNG CÔNG NGHỆ & TÂM HUYẾT</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-white/20 text-white hover:bg-white hover:text-black font-black uppercase tracking-widest px-8 py-7 text-lg h-auto transition-all bg-transparent"
              >
                Xem dịch vụ
              </Button>
            </div>
